...
import mim.com.dc3scanner2.util.adapters.SancionesAdapter;
...
public class SancionesFragment extends Fragment {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.sanciones_menu,menu);
    }

    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.crear_sancion:
                mListener.showCreateSancionForm();
                break;
        }
        return true;
    }
