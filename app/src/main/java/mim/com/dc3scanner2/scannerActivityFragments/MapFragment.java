...
public class MapFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FrameLayout view = (FrameLayout) inflater.inflate(R.layout.fragment_map, container, false);

        canvas = new MapView4(this.getContext(), R.raw.mapa);
        ...
        imageView = view.findViewById(R.id.imaview_map);
        ...
        Picasso.get().load(R.raw.mapa_mini).fit().
                into(imageView);
        return view;
