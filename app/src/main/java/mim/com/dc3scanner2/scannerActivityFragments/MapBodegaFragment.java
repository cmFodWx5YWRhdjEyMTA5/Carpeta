...
import mim.com.dc3scanner2.util.custom.MapView4Bodega;
import mim.com.dc3scanner2.util.custom.MapView4BodegaImprovedMap;
...
public class MapBodegaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        canvas = new MapView4BodegaImprovedMap(this.getContext(), R.raw.bodega_nuevo);
        ...
        imageView = view.findViewById(R.id.imaview_map_bodega);
        ...
        Picasso.get().load(R.raw.bodega_mini).fit().
                into(imageView);
        return view;
