...
// you provide access to all the views for a data item in a view holder
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            nombreCompañia = layout.findViewById(R.id.nombre_compañia_list_item_permiso);
            descripcion = layout.findViewById(R.id.descripcion_permiso);
            descripcion.setEnabled(false);
            area = layout.findViewById(R.id.area_permiso);
            area.setEnabled(false);
            sub = layout.findViewById(R.id.subarea_permiso);
            sub.setEnabled(false);
            cerrarBtn = layout.findViewById(R.id.cerrar_permiso_btn);
        }
    }

    // Provide a suitable constructor (depends on the kind of dataset)
    public PermisosAdapter(List<PermisoTrabajo> myDataset, ListenerClick listener,Transition mListener) {
    ...
    @Override
    public PermisosAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                         int viewType) {
